...
This ordering was designed to alternate between intensification (Active Reversion) and diversification (the remaining three operators), ensuring thorough exploration of the search space before 
accepting a local optimum.
