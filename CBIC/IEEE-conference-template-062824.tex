...
\begin{abstract}
    ...
    Busca em Vizinhança Variável (Variable Neighborhood Search - VNS) e avaliamos seu desempenho em comparação com uma metaheurística populacional, especificamente o Algoritmo Genético (Genetic Algorithm - GA). Os resultados
...
Neste contexto, o presente estudo propõe a otimização da cadeia de suprimentos do pistache mediante a aplicação da Busca em Vizinhança Variável (Variable Neighborhood Search - VNS), uma heurística reconhecida por sua 
...
\begin{figure}
  \begin{center}
      ...
      \caption{Cadeia de Suprimentos de Pistache proposta}
