...
Diferentemente de \cite{b2}, que utiliza codificação real com valores contínuos entre 0 e 1, adotamos uma abordagem baseada em números inteiros sequenciais de 1 a $Z$, onde $Z$ representa o número total 
...
Para a decodificação de cada fluxo da cadeia de suprimentos, utilizamos a função \textit{decodingStep}. Este procedimento corresponde exatamente ao \textit{Procedure 1} apresentado na Fig. 3 do artigo \cite{b12}. 
