...
Para a decodificação de cada fluxo da cadeia de suprimentos, é utilizada a função \textit{decodingStep}. Este procedimento corresponde exatamente ao \textit{Procedure 1} apresentado na Fig. 3 do artigo \cite{b12}. 
