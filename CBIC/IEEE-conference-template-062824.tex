...
vinculados às variáveis associadas aos produtores. Abordagens semelhantes foram adotadas em outros estudos (\hspace{-0.03em}\cite{b11,b19,b20}), e a implementação rigorosa de um circuito de feedback poderia ser uma direção promissora para pesquisas futuras. 
