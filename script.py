...
dc.decode(sources_E, depots_SN2, demand_N2S, production_capacity_E, total_shipment_cost_E, chromo_ESN2)
...
dc.decode(sources_J, depots_KE, demand_KE, production_capacity_J, total_shipment_cost_J, chromo_JKE)
