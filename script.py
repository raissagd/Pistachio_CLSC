...
I, J, K, E, Q, S, N1, N2, N3, M = 6, 4, 2, 2, 2, 2, 4, 4, 2, 4
...
#ILS = VariableNeighborhoodSearch([Swap(5), Reversion(10), Insertion(4), MaxMinSwap(5), Slide(6), ETN(5), RS(5), SPS(3), SRPS(4)], 50)
#ILS.solve(data)